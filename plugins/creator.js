...
let handler = async(m, { conn }) => {
	...
	await delay(100)
  return conn.sendMessage(m.chat, { text: `Hay kak @${await m.sender.split('@')[0]}, itu nomor ownerku Kalau g penting G usah Chat ^_^`, mentions: [m.sender] }, { quoted: conn.p[id][0] })
  await delay(100)
